...
Pull requests must **not** be opened automatically by bots or other automated tooling without a human in the loop, unless specifically approved in advance by the project. To request permission to submit such a PR, the human owner of the bot must open an issue for approval in advance of the PR's submission.
...
- `vizro-experimental/`: The incubation home for Vizro features that aren't ready for `vizro-core`.
