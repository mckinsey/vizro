...
!!! notice "Notice"
    ...
    Users must connect to large language models (LLMs) to use Vizro-AI. Please review our [guidelines on the use of LLMs](pages/explanation/safety-in-vizro-ai.md) and how Vizro-AI handles [code execution and data](pages/explanation/safeguard.md) — it does not execute model-generated code.
