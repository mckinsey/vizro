    ...
    === "Code for the cell"
        ...
        page = vm.Page(
            ...
            components=[
                ...
                vm.Graph(
                    figure=px.box(df, x="continent", y="lifeExp", color="continent", title="Life Expectancy per Continent")
                ),
            ],
            controls=[vm.Filter(column="country"), vm.Filter(column="continent")],
        )
