...
from actions import data_upload_action, display_filename, run_vizro_ai, update_table, image_upload_action, run_image_ai
            ...
            components=[
                vm.Container(
                    ...
                    components=[
                        ...
                        UserUpload(
                            id="img-upload-component",
                            actions=[
                                vm.Action(
                                    function=image_upload_action(),
                                    inputs=["img-upload-component.contents",],
                                    outputs=["img-store.data"]
                                )
                            ]
                        )
                    ],
