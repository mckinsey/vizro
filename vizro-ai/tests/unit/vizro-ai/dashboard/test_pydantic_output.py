...
from vizro_ai.dashboard._pydantic_output import _create_message_content, _create_prompt_template, _get_pydantic_output


def test_get_pydantic_output(component_description, fake_llm):
    pydantic_output = _get_pydantic_output(
