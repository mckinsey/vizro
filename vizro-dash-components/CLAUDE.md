...
- `hatch run example` - Run the multi-page example app on port 8050 (Home, Cascader, and Markdown pages)
...
- `examples/app.py` - Multi-page Dash app entry point (run with `hatch run example`)
- `examples/pages/home.py` - Home page with links to component showcases
- `examples/pages/cascader.py` - Cascader component showcase page
- `examples/pages/markdown.py` - Markdown component showcase page
