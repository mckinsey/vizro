...
- `dash[dev]` on PATH (provides `dash-generate-components`, needed by `hatch run npm:build`)
- Run `hatch run npm:install` once after cloning to install npm dependencies
