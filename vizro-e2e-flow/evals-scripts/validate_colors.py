...
VIZRO_HEX_COLORS = frozenset({
    "#097DFE", "#6F39E3", "#05D0F0", "#0F766E", "#8C8DE9", "#11B883",
    "#E77EC2", "#C84189", "#C0CA33", "#3E495B",
    "#DBEBFE", "#BDDCFE", "#8CC6FF", "#4BA5FF", "#097DFE", "#0063F6",
    "#004DE0", "#0B40B4", "#163B8B",
    "#EBE9FC", "#DAD6FB", "#C0B6FB", "#A08AF8", "#855FF6", "#6F39E3",
    "#6630D5", "#5529B1", "#47268E",
    "#D2F9FC", "#AAF2FA", "#68E8F7", "#05D0F0", "#00B7D4", "#0092B2",
    "#087490", "#155E74", "#1A4E61",
    "#D4F9E7", "#ADF1D3", "#73E6BA", "#2CD099", "#11B883", "#07966B",
    "#0B7859", "#0F5E48", "#114D3C",
    "#F8E9F5", "#F3D3EB", "#EDAFDD", "#E77EC2", "#DB5AB1", "#C84194",
    "#AB3478", "#8D2D63", "#742A53",
    "#F4F9D2", "#EAF3A9", "#DBE973", "#CBD740", "#C0CA33", "#979912",
    "#76720C", "#605B11", "#514C15",
    "#EFF1F4", "#E0E4E9", "#C9D0D9", "#97A1B0", "#6D788A", "#505C6F",
    "#3E495B", "#2A3241", "#1D222E",
    "#D0FAF3", "#A1F4E8", "#64E9D9", "#1BD0C1", "#00B5A9", "#00918A",
    "#0F766E", "#0F5B59", "#144B49",
    "#FBE4E2", "#FACDC9", "#F7AAA3", "#F1766C", "#EA5748", "#D63A28",
    "#B22F20", "#922A20", "#782921",
    "#FFF7CD", "#FFED9B", "#FFE16A", "#FFD545", "#FFC107", "#DBA005",
    "#B78103", "#936402", "#7A4F01",
    "#FFFFFF", "#000000",
})
    ...
    if not visitor.violations:
        ...
        for v in visitor.violations:
            if v["type"] == "forbidden_color_kwarg":
                ...
                checks.append({
                    "check": f"app.py: no non-Vizro hex color",
                    "status": "FAIL",
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print(f"Usage: {sys.argv[0]} <project_dir> [--custom-colors-requested]", file=sys.stderr)
        sys.exit(1)
