...
- Add eval framework with 3 business-first test cases and updated skill guidance for data pre-aggregation. ([#1692](https://github.com/mckinsey/vizro/pull/1692)) <a id='changelog-0.1.4'></a>
