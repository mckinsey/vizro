...
from pages.examples import beeswarm, boxplot, cumulative_curve, dumbbell, histogram, violin
...
pages = [violin_page, boxplot_page, beeswarm_page, butterfly_page, cumulative_curve_page, dumbbell_page, histogram_page]
