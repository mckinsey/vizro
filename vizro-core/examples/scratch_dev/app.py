...
page_0 = vm.Page(
    ...
    controls=[
        ...
        vm.Filter(column="datetime_utc", selector=vm.DatePicker(title="datetime_utc date")),
        ...
        vm.Filter(column="date_yyyy_mm_dd", selector=vm.DatePicker(title="date_yyyy_mm_dd")),
        vm.Filter(column="date_yyyy_mm_dd", selector=vm.DatePicker(title="date_yyyy_mm_dd + value", value=["2026-01-01", "2026-12-31"])),
        # time columns — TimePicker only
        vm.Filter(column="time_iso", selector=vm.TimePicker(title="time_iso")),
        vm.Filter(column="time_hh_mm_ss", selector=vm.TimePicker(title="time_hh_mm_ss + value", value=["00:00", "23:59"])),
        vm.Filter(column="time_hh_mm", selector=vm.TimePicker(title="time_hh_mm")),
    ],
)
