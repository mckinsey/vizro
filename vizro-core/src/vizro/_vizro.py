...
class Vizro:
    ...
    def __init__(self, **kwargs):
        """Initializes Dash app, stored in `self.dash`, passing parameters through to `Dash.__init__`."""
        # **kwargs is passed through to `Dash.__init__`, e.g. `assets_folder`, `url_base_pathname`.
