...
def set_layout(layout, info: ValidationInfo):
    ...
    # This exists only to eagerly raise the error, otherwise obscure error message on, for example, Page()
...
@deprecated(
    "The `Layout` model has been renamed [`Grid`][vizro.models.Grid], and [`Layout` will not exist in Vizro 0.2.0]"
