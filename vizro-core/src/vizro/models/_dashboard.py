...
class Dashboard(VizroBaseModel):
    ...
    def _get_logo_images(self):
        ...
        logo = html.A(html.Img(id="logo", src=path_to_logo, hidden=not path_to_logo), href=get_relative_path("/"))
        logo_dark = html.A(html.Img(id="logo-dark", src=path_to_logo_dark, hidden=not path_to_logo_dark), href=get_relative_path("/"))
        logo_light = html.A(html.Img(id="logo-light", src=path_to_logo_light, hidden=not path_to_logo_light), href=get_relative_path("/"))
