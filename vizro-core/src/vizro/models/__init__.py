...
from ._components import Card, Container, Graph, Grid, Table, Tabs
...
Container.update_forward_refs(Button=Button, Card=Card, Graph=Graph, Grid=Grid, Layout=Layout, Table=Table, Tabs=Tabs)
