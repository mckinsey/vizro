export function _update_range_slider_values(start, end, slider, input_store, self_data) {
    ...
    if (trigger_id === `${self_data["id"]}_start_value` || trigger_id === `${self_data["id"]}_end_value`) {
