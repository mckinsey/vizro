...
function show_progress_notification(trigger, notificationObject, actionParameters, ...actionRuntimeArguments){
  ...
  dash_clientside.set_props("vizro-notifications", {sendNotifications: copyNotificationObject});
}
