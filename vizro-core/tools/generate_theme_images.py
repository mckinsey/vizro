...
def generate_colors_image(output_path):
    ...
    color_groups = {
        ...
        "Blue": ["blue_50"] + [f"blue_{i}00" for i in range(1, 10)] + ["blue_950"],
        "Purple": ["purple_50"] + [f"purple_{i}00" for i in range(1, 10)] + ["purple_950"],
        "Turquoise": ["turquoise_50"] + [f"turquoise_{i}00" for i in range(1, 10)] + ["turquoise_950"],
        "Green": ["green_50"] + [f"green_{i}00" for i in range(1, 10)] + ["green_950"],
        "Pink": ["pink_50"] + [f"pink_{i}00" for i in range(1, 10)] + ["pink_950"],
        "Yellow": ["yellow_50"] + [f"yellow_{i}00" for i in range(1, 10)] + ["yellow_950"],
        "Grey": ["gray_50"] + [f"gray_{i}00" for i in range(1, 10)] + ["gray_950"],
