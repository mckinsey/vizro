...
!!! example "First component" === "app.py"
...
!!! example "Add components" === "Code first component" \`\`\`py
...
!!! example "Configure layout" === "Code" `py         layout=vm.Layout(grid=[[0, 0], [1, 2], [1, 2], [1, 2]])         ` === "app.py"
...
!!! example "Configure filter" === "Code" `py         controls=[                 vm.Filter(column="continent", targets=["box_cont", "line_gdp"]),             ]         ` === "app.py"
