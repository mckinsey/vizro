...
Follow the [Edit live on Py.Cafe](https://py.cafe/vizro./vizro-iris-analysis-0) link below the dashboard to see the code and experiment with it.

<iframe src="https://py.cafe/vizro./vizro-iris-analysis-0" width="100%" height="600px"></iframe>
