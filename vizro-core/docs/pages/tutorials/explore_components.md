...
on using and configuring different `components`, refer to our user guides on [components](../user_guides/components.md). It serves as a detailed resource to learn about the wide range of `components` available and how to make the most of them
in your dashboards.
...
For future dashboard creations, you can explore more about the available dashboard `components` by going through our
[overview](../user_guides/components.md). To gain more in-depth knowledge about the usage and configuration
