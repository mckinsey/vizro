---
description: "Signatures for every built-in action in `vizro.actions`: `export_data`, `filter_interaction`, `set_control`, `set_controls`, `show_notification`, `update_notification`, `update_targets`, and the `AbstractAction` base."
---
