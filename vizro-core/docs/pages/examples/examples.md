...
You can find the code for each of the charts, for each page of the dashboard on our [Hugging Face gapminder demo space](https://huggingface.co/spaces/vizro/Main_Demo). The code is available as a [`.py` file](https://huggingface.co/spaces/vizro/Main_Demo/blob/main/app.py).
