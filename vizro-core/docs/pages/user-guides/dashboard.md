...
!!! example "Dashboard Configuration Syntaxes" === "app.py - pydantic models" \`\`\`{.python pycafe-link} import vizro.plotly.express as px from vizro import Vizro import vizro.models as vm
