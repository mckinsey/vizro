...
It is possible to add filters to a [page](pages.md) or [container](container.md#add-controls-to-container). Both the [`Page` model](../API-reference/models.md#vizro.models.Page) and the [`Container` model](../API-reference/models.md#vizro.models.Container) have an optional `controls` argument where you can give any number of controls, including filters. A filter uses the [`Filter` model](../API-reference/models.md#vizro.models.Filter) to filter the `data_frame` of the `figure` function of a target component model such as [`Graph`](../API-reference/models.md#vizro.models.Graph).
...
1. add the [`Filter`](../API-reference/models.md#vizro.models.Filter) model into the `controls` argument of the [`Page`](../API-reference/models.md#vizro.models.Page) model
...
- Categorical data uses [`vm.Dropdown(multi=True)`](../API-reference/models.md#vizro.models.Dropdown) where `options` is the set of unique values found in `column` across all the data sources of components in `targets`.
- [Numerical data](https://pandas.pydata.org/docs/reference/api/pandas.api.types.is_numeric_dtype.html) uses [`vm.RangeSlider`](../API-reference/models.md#vizro.models.RangeSlider) where `min` and `max` are the overall minimum and maximum values found in `column` across all the data sources of components in `targets`.
- [Temporal data](https://pandas.pydata.org/docs/reference/api/pandas.api.types.is_datetime64_any_dtype.html) uses [`vm.DatePicker(range=True)`](../API-reference/models.md#vizro.models.DatePicker) where `min` and `max` are the overall minimum and maximum values found in `column` across all the data sources of components in `targets`. A column can be converted to this type with [pandas.to_datetime](https://pandas.pydata.org/docs/reference/api/pandas.to_datetime.html).
- [Boolean data](https://pandas.pydata.org/docs/reference/api/pandas.api.types.is_bool_dtype.html) uses [`vm.Switch`](../API-reference/models.md#vizro.models.Switch) which provides a toggle interface for True/False values. The Switch also works with binary numerical columns containing 0/1 values.
...
If you want to have a different selector for your filter, you can give the `selector` argument of the [`Filter`](../API-reference/models.md#vizro.models.Filter) model a different selector model. Currently available selectors are [`Checklist`](../API-reference/models.md#vizro.models.Checklist), [`Dropdown`](../API-reference/models.md#vizro.models.Dropdown), [`RadioItems`](../API-reference/models.md#vizro.models.RadioItems), [`RangeSlider`](../API-reference/models.md#vizro.models.RangeSlider), [`Slider`](../API-reference/models.md#vizro.models.Slider), [`DatePicker`](../API-reference/models.md#vizro.models.DatePicker) and [`Switch`](../API-reference/models.md#vizro.models.Switch).
...
For further customizations, refer to the [guide to selectors](selectors.md) and the [`Filter` model](../API-reference/models.md#vizro.models.Filter). Some popular choices are:
