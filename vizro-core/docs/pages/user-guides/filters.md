...
!!! example "Basic Filter" === "app.py" \`\`\`{.python pycafe-link} from vizro import Vizro import vizro.plotly.express as px import vizro.models as vm
...
!!! example "Filter with custom Selector" === "app.py" \`\`\`{.python pycafe-link} from vizro import Vizro import vizro.plotly.express as px import vizro.models as vm
...
!!! example "Advanced Filter" === "app.py" \`\`\`{.python pycafe-link} from vizro import Vizro import vizro.plotly.express as px import vizro.models as vm
