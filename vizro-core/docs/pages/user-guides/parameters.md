...
!!! example "Basic Parameter" === "app.py" \`\`\`{.python pycafe-link} from vizro import Vizro import vizro.plotly.express as px import vizro.models as vm
...
!!! example "Nested Parameters for multiple targets" === "app.py" \`\`\`{.python pycafe-link} from vizro import Vizro import vizro.plotly.express as px import vizro.models as vm
