...
The Vizro version of this AG Grid differs in one way from the original Dash AG Grid: it requires the user to pass a pandas dataframe as source of data.
...
Sometimes a parameter may not work because it requires an extra callback to function. In that case you can try
...
The Vizro version of this table differs in one way from the original table: it requires the user to pass a pandas dataframe as source of data.
