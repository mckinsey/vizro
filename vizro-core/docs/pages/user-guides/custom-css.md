...
To adjust CSS properties for specific components, such as altering the appearance of a selected [`Card`](../user-guides/card.md) rather than all Cards, supply an `id` to the component you want to style.
