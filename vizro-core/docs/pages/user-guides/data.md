...
!!! example "Static data supplied directly" === "app.py" \`\`\`py from vizro import Vizro import pandas as pd import vizro.plotly.express as px import vizro.models as vm
...
!!! example "Static data referenced by name" === "app.py" \`\`\`py import yaml
...
!!! example "Dynamic data" === "app.py" \`\`\`py from vizro import Vizro import pandas as pd import vizro.plotly.express as px import vizro.models as vm
...
!!! example "Parametrized dynamic data" === "app.py" \`\`\`py hl_lines="8 10 20-23" from vizro import Vizro import pandas as pd import vizro.plotly.express as px import vizro.models as vm
