...
??? example "Custom Dash DataTable" === "app.py" \`\`\`{.python pycafe-link} from dash import dash_table
...
??? example "Custom Dash AgGrid" === "app.py" \`\`\`{.python pycafe-link} import vizro.models as vm import vizro.plotly.express as px from dash_ag_grid import AgGrid from vizro import Vizro from vizro.models.types import capture
