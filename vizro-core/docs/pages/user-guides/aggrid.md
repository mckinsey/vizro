...
No specific formatting is available for custom objects and strings, however one can make use of [Value Formatters](https://dash.plotly.com/dash-ag-grid/value-formatters)
