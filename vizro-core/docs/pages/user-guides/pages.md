...
This guide shows you how to add pages to your dashboard and customize the URL paths if needed. A [`Page`](../API-reference/models.md#vizro.models.Page) model enables you to:
...
The [`Dashboard`](../API-reference/models.md#vizro.models.Dashboard) model accepts the `pages` argument, where you can insert your [`Page`](../API-reference/models.md#vizro.models.Page) model.

## Create a page

A [`Page`](../API-reference/models.md#vizro.models.Page) splits into four main containers:
...
1. Set a `title` for your [`Page`](../API-reference/models.md#vizro.models.Page) model (which does not have to be unique)
...
To customize the page URL, pass a valid URL name to the `path` argument of [`Page`](../API-reference/models.md#vizro.models.Page) model:
