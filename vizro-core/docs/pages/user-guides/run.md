...
Most of our examples have a link below the code, [Run and edit this code in Py.Cafe](https://py.cafe/vizro-official/vizro-iris-analysis), which you can follow to experiment with the code. This leads you to an editor such as the one below, which displays the dashboard and the code side by side.
