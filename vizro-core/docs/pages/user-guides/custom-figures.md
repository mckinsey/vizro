...
!!! example "Custom KPI card"
    === "app.py"
        ...
        1. This creates a [`grid`](layouts.md) with four rows and four columns. The KPI cards are positioned in the first two cells, while the remaining cells are empty.
