...
!!! example "Custom KPI card" === "app.py" \`\`\`{.python pycafe-link} from typing import Optional
...
!!! example "Dynamic HTML header" === "app.py" \`\`\`{.python pycafe-link} import pandas as pd import vizro.models as vm from dash import html from vizro import Vizro from vizro.models.types import capture
...
!!! example "Dynamic number of cards" === "app.py" \`\`\`py from typing import Optional
