...
!!! example "Dynamic number of cards"
    === "app.py"
        ...
        <img src=https://py.cafe/logo.png alt="py.cafe logo" width="30"><b><a target="_blank" href="https://py.cafe/vizro./vizro-dynamic-cards">Run and edit this code in Py.Cafe</a></b>
