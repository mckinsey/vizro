...
Some of our models, for example, the [`Container`](../user-guides/container.md), have an argument called `extra`. This argument enables the user to pass extra arguments directly to the underlying component of the model. In the case of the `Container`, this would be the [`dbc.Container`](https://www.dash-bootstrap-components.com/docs/components/layout/).
