...
class TestDropdownBuild:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (["A" * 48, "B", "C"], 104),
            (["A" * 49, "B", "C"], 128),
            ([{"label": "A" * 24, "value": "A"}, {"label": "B", "value": "B"}, {"label": "C", "value": "C"}], 56),
            ([{"label": "A" * 25, "value": "A"}, {"label": "B", "value": "B"}, {"label": "C", "value": "C"}], 80),
            ([{"label": "A" * 48, "value": "A"}, {"label": "B", "value": "B"}, {"label": "C", "value": "C"}], 104),
            ([{"label": "A" * 49, "value": "A"}, {"label": "B", "value": "B"}, {"label": "C", "value": "C"}], 128),
        ],
    )
