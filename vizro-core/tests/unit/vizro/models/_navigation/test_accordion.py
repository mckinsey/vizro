...
class TestAccordionBuild:
    ...
    def test_accordion(self, pages, expected):
        ...
        assert_component_equal(accordion, html.Div(id="nav_panel"), keys_to_strip={"children", "className"})
    ...
    def test_accordion_one_page(self):
        ...
        assert_component_equal(accordion, html.Div(hidden=True, id="nav_panel"), keys_to_strip={})
