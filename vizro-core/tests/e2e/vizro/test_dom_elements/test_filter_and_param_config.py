...
from e2e.vizro.checkers import check_graph_y_axis_value
...
def test_filter_and_parameter(dash_br):
    ...
    check_graph_y_axis_value(dash_br, graph_id=cnst.BOX_FILTER_AND_PARAM_ID, tick_index="6  ", value="0.6")

    # Check that title is still 'red'
    dash_br.wait_for_text_to_equal(".gtitle", "red")
