...
- Introduce KPI card functions to be used inside `Figure`. See the [user guide on KPI cards](#kpi-key-performance-indicator-cards) for more information. ([#493](https://github.com/mckinsey/vizro/pull/493), [#529](https://github.com/mckinsey/vizro/pull/529))
